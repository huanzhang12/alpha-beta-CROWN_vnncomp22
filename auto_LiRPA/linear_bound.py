class LinearBound:
    def __init__(
            ...
            from_input=None, nominal=None, lower_offset=None, upper_offset=None,
            x_L=None, x_U=None, offset=0, tot_dim=None):
        self.lw = lw
        self.lb = lb
        self.uw = uw
        self.ub = ub
    ...
    def is_single_bound(self):
        """Check whether the linear lower bound and the linear upper bound are the same."""
