...
from attack_pgd import AdamClipping, pgd_attack_with_general_specs, test_conditions, gen_adv_example
...
def batch_verification_input_split(
    ...
    # ret = pick_out_batch_input_split(d, batch, device=net.x.device)
...
def input_bab_parallel(
    ...
    if hasattr(net.net[net.net.input_name[0]], 'lA'):
        ...
        raise ValueError("sb-fast heuristic cannot be used without lA.")
    dm_l = x.ptb.x_L
    dm_u = x.ptb.x_U
